    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        <div class="menu_section">
            <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i>Télécharger<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><?php echo $this->Html->link('Catalogues et bons commande', '/files/index/catalogue', ['escape' => false]); ?></li>
                        <li><?php echo $this->Html->link('Factures', '/files/index/catalogue', ['escape' => false]); ?></li>
                    </ul>
                </li>
